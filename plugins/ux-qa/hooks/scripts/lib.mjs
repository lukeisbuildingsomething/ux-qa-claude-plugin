...
export function nudgeText(files, root) {
  ...
  return [
    ...
    '  - Put the single highest-severity Tier-2 finding to the user with',
    '    AskUserQuestion at the end of this turn. One question, never a list.',
    '    Buffer the rest to DECISIONS.md for later turns.',
    '  - Stay silent entirely if the finding is below `annoys` severity, if you',
    '    already asked a ux-qa question this turn, or if the user is mid-flow on',
    '    something unrelated and urgent.',
    '  - Say at most one sentence before the question.',
