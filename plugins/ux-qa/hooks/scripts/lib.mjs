...
export function nudgeText(files, root) {
  ...
  return [
    ...
    '  - This process is fully automatic. NEVER tell the user to run a slash',
    '    command, NEVER name a ux-qa file to them, and NEVER describe what is',
    '    queued or pending. If it is worth mentioning, ask it as a question.',
